...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://rzyvfx.com/#testimonials',
									});
								},
								function() { 
					
									window._sectionTimeoutId = setTimeout(function() { doNextSection(); }, 3000);
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://rzyvfx.com',
									});
								},
							],
						},
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style12, h2.style12, h3.style12, p.style12', { style: 'fade-down', speed: 1000, intensity: 3, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('h1.style14, h2.style14, h3.style14, p.style14', { style: 'fade-up', speed: 1000, intensity: 3, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'zoom-out', speed: 1625, intensity: 5, threshold: 1, delay: 250, state: true, replay: true });
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 750, intensity: 3, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-left', speed: 1000, intensity: 3, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('.video.style2', { style: 'zoom-out', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video08', { style: 'zoom-in', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('.video.style1', { style: 'zoom-out', speed: 1500, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video03', { style: 'zoom-out', speed: 1500, intensity: 5, threshold: 2, delay: 1000, state: true, replay: true });
		onvisible.add('#video02', { style: 'zoom-out', speed: 1500, intensity: 5, threshold: 2, delay: 1250, state: true, replay: true });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-right', speed: 1000, intensity: 3, threshold: 3, delay: 0, state: true, replay: true });
		onvisible.add('.icons.style2', { style: 'fade-down', speed: 1000, intensity: 3, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', state: true, replay: false });
		onvisible.add('.buttons.style3', { style: 'fade-up', speed: 750, intensity: 3, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('#video11', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video12', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video29', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video30', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('.buttons.style4', { style: 'fade-up', speed: 750, intensity: 3, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('#video17', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video18', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('#video19', { style: 'fade-up', speed: 2000, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video20', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video21', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video22', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('#video23', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video24', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video25', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video26', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('#video27', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video28', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video10', { style: 'zoom-in', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video13', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video16', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 0, state: true, replay: true });
		onvisible.add('#video14', { style: 'fade-up', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
		onvisible.add('#video15', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 500, state: true, replay: true });
		onvisible.add('#video09', { style: 'fade-up', speed: 2000, intensity: 5, threshold: 2, delay: 750, state: true, replay: true });
		onvisible.add('#video05', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 2, delay: 250, state: true, replay: true });
