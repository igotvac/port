...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Plasma',
										'page_location': 'https://rzyvfx.com/#plasma',
									});
								},
							],
						},
					...
					'loveliveserve': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Loveliveserve',
										'page_location': 'https://rzyvfx.com/#loveliveserve',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Hk-vibin',
										'page_location': 'https://rzyvfx.com/#hk-vibin',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Faze',
										'page_location': 'https://rzyvfx.com/#faze',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Montages',
										'page_location': 'https://rzyvfx.com/#montages',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://rzyvfx.com/#long-form',
									});
								},
							],
						},
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('h1.style15, h2.style15, h3.style15, p.style15', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 1, delay: 0, state: true, replay: true });
		onvisible.add('h1.style16, h2.style16, h3.style16, p.style16', { style: 'zoom-in', speed: 1500, intensity: 10, threshold: 1, delay: 0, state: true, replay: true });
